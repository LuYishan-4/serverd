...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1341: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1342: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      ...
      _1358: (x0,x1) => x0.createElement(x1),
      ...
      _1385: (x0,x1) => x0.initialize(x1),
      _1386: (x0,x1) => x0.initTokenClient(x1),
      _1387: (x0,x1) => x0.initCodeClient(x1),
      _1389: (x0,x1) => x0.warn(x1),
      _1390: x0 => x0.disableAutoSelect(),
      _1391: x0 => x0.decode(),
      ...
      _1398: (x0,x1) => x0.getItem(x1),
      _1399: (x0,x1) => x0.removeItem(x1),
      _1400: (x0,x1,x2) => x0.setItem(x1,x2),
      _1401: Date.now,
      ...
      _1610: () => new FileReader(),
      _1611: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1612: x0 => x0.trustedTypes,
      _1613: (x0,x1) => { x0.src = x1 },
      _1614: (x0,x1) => x0.createScriptURL(x1),
      _1615: x0 => x0.nonce,
      _1616: (x0,x1) => x0.debug(x1),
      _1617: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1617(f,arguments.length,x0) }),
      _1618: x0 => ({createScriptURL: x0}),
      _1619: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1620: (x0,x1) => x0.querySelectorAll(x1),
      ...
      _1695: () => globalThis.google.accounts.oauth2,
      ...
      _1702: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12) => ({client_id: x0,scope: x1,include_granted_scopes: x2,redirect_uri: x3,callback: x4,state: x5,enable_granular_consent: x6,enable_serial_consent: x7,login_hint: x8,hd: x9,ux_mode: x10,select_account: x11,error_callback: x12}),
      _1706: x0 => x0.error,
      ...
      _1711: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _1712: x0 => x0.requestAccessToken(),
      _1713: (x0,x1) => x0.requestAccessToken(x1),
      _1714: (x0,x1,x2,x3,x4,x5,x6) => ({scope: x0,include_granted_scopes: x1,prompt: x2,enable_granular_consent: x3,enable_serial_consent: x4,login_hint: x5,state: x6}),
      _1715: x0 => x0.access_token,
      _1716: x0 => x0.expires_in,
      _1719: x0 => x0.token_type,
      _1722: x0 => x0.error,
      _1725: x0 => x0.type,
      _1730: () => globalThis.google.accounts.id,
      _1733: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1733(f,arguments.length,x0) }),
      _1734: (x0,x1) => x0.prompt(x1),
      ...
      _1750: x0 => x0.isNotDisplayed(),
      _1751: x0 => x0.isSkippedMoment(),
      _1752: x0 => x0.isDismissedMoment(),
      _1754: x0 => x0.getNotDisplayedReason(),
      _1755: x0 => x0.getSkippedReason(),
      _1756: x0 => x0.getDismissedReason(),
      _1758: x0 => x0.error,
      _1760: x0 => x0.credential,
      _1819: (x0,x1) => { x0.responseType = x1 },
      _1820: x0 => x0.response,
      _1896: x0 => x0.style,
      _1909: (x0,x1) => { x0.oncancel = x1 },
      _1915: (x0,x1) => { x0.onchange = x1 },
      _1955: (x0,x1) => { x0.onerror = x1 },
      _2095: (x0,x1) => { x0.nonce = x1 },
      _2255: (x0,x1) => { x0.download = x1 },
      _2280: (x0,x1) => { x0.href = x1 },
      _2328: (x0,x1) => { x0.src = x1 },
      _2339: x0 => x0.width,
      _2341: x0 => x0.height,
      ...
      _3141: (x0,x1) => { x0.defer = x1 },
      _3177: x0 => x0.width,
      _3178: (x0,x1) => { x0.width = x1 },
      _3179: x0 => x0.height,
      _3180: (x0,x1) => { x0.height = x1 },
      _3601: () => globalThis.window,
      _3641: x0 => x0.document,
      _3663: x0 => x0.navigator,
      _3925: x0 => x0.trustedTypes,
      ...
      _13098: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _13099: f => finalizeWrapper(f, function() { return dartInstance.exports._13099(f,arguments.length) }),
